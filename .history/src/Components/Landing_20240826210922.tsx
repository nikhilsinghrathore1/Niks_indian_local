...
const Landing = () => {
  return (
    <div className=' w-full h-screen f1 overflow-hidden fixed text-white '>
               {/* this is the nav-bar */}
               <nav className='w-full fixed px-10 flex items-center bg-black justify-around'>
                              <div className='menu-btn w-fit bg-black/10 rounded-[40px] backdrop-blur-[20px] px-[6px] py-[]'>
                                             <h1>menu</h1>
                              </div>
                              <div className='logo'>
                                             <h1>NikoChan</h1>
