...
const Landing = () => {
  return (
    <div className=' w-full h-screen font-serif overflow-hidden fixed text-white bg-black'>
               {/* this is the nav-bar */}
               <nav className='w-full fixed px-10 flex items-center  justify-around text-xl'>
                              <div className='menu-btn w-fit bg-black/10 rounded-[40px] backdrop-blur-[20px] px-12 py-[12px]'>
                                             <h1>menu</h1>
                              </div>
