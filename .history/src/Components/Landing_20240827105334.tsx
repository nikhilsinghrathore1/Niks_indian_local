...
const Landing: React.FC = () => {
  ...
  return (
    <div className='w-full h-screen overflow-hidden fixed text-white bg-black'>
      {/* Nav Bar */}
      <nav className='w-full fixed flex pt-2 items-center justify-around gap-[300px] text-lg z-50'>
        <div className='menu-btn w-fit bg-zinc-700 rounded-full backdrop-blur-md px-5 py-2 cursor-pointer'>
